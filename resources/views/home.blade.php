        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    @include('layouts.hero-categories')
            ...
            <div class="row">
                <div class="categories__slider owl-carousel">
                    @foreach ($categories as $category)
                        <div class="col-lg-3">
                            <div class="categories__item set-bg" data-setbg="./template/img/categories/Category.jpg">
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="template/img/featured/Product.jpg">
